...
def _read_drug() -> List[Tuple[int, int, int, int]]:
    return _read_ml('DD/shuffle_user_rating.dat', '::')
...
def drugdata() -> List[Tuple[int, int, int, int]]:
    return _load_data(_read_drug, 195439, 10000, 155, 'drug')
