...
if __name__ == "__main__":
    ...
    #测试预测结果
    print("prediction: ", lightgcn.predict(user=40, item=1))
    print("recommendation: ", lightgcn.recommend_user(user=44, n_rec=7))
...
# 测试集数据列表：用户-[多个项目]
    ...
    for user in user_column:
        rec_items = lightgcn.recommend_user(user=user, n_rec=25)      
