if __name__ == '__main__':
    ...
    n_user, n_item, n_entity, n_relation, train_data, test_data, kg, topk_data = data_process.pack_kg(kg_loader.drug_data, negative_sample_threshold=4)

    neighbor_size = 16

    #根据构建的无向知识图谱和给定的邻居节点数量，获取实体和关系的邻接列表
